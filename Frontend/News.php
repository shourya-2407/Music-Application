...
<div class="header_under"></div>
    ...
    <table align="center">
    <tr><td>
    <h1>CONSTRUCTION OF THIS PAGE IS ONGOING!!</h1>
    </td></tr>
    </table>
	</div><!--End Container-->
<div class="footer_wrapper">
    <div class="footer_menu">
    	<ul>
        	<li>Find the us <a href="../../music_x/Contacts.php">BMEG Music Office</a> or <a href="../../music_x/Contacts.php">contact us</a> for more information</li>    
        </ul>
        <br /> <br /> <br />
